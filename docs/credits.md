...
| `scientist_colossus.glb` (scientist_-_wolf._new_colossus) | "Scientist - Wolf. New Colossus" by Nazar Okruzhko - sketchfab.com/3d-models/scientist-wolf-new-colossus-cf741db7e572453397700b9d04eb9cc0 | Textures 512 px, rig kept | **Not used.** Its textures carry Nazi insignia (swastika and eagle on the helmet, Balkenkreuze, swastikas on the ID badge and on the boots) - it is a Wolfenstein asset. Recommend removing it from the repository. |
